...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.logo_image = ctk.CTkImage(Image.open(os.path.join(path, "logo_single.png")), size=(26, 26))

        self.home_image = ctk.CTkImage(Image.open(os.path.join(path, "home_light.png")), size=(20, 20))
        self.chat_image = ctk.CTkImage(Image.open(os.path.join(path, "chat_light.png")), size=(20, 20))
        self.add_user_image = ctk.CTkImage(Image.open(os.path.join(path, "add_user_light.png")), size=(20, 20))
